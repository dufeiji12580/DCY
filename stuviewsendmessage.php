...
<?php 
	if($_SERVER['REQUEST_METHOD'] == 'POST')						
	{
		if($_POST['check'])											
		{
			...
			{
				mysql_query("update stotmessage set studelete = 1 where FST_ID = ".$id,$myconn);
				mysql_query("delete from stotmessage where FST_ID = ".$id." and teadelete = 1",$myconn);
			}
		}
	}
?>
...
$query_Recordset1 = "SELECT FT_ID,FST_ID,T_Name,Stot_Topic,View FROM teacher natural join stotmessage where S_Username = '".$_SESSION[S_Username]."' and studelete = 0 order by FST_ID desc";
...
<div align="center">
  ...
  <tr>
    ...
    <tr>
      ...
      <?php if($totalRows_Recordset1!=0){?><table width="452" border="0" >
          <tr>
            ...
            <tr>
              <td align="center" width="30"><input type="checkbox" name="allbox" id="allbox" onclick = javascript:CA() /></td>
              <td align="center" width="143">姓名</td>
              <td align="center" width="217">主题</td>
              <td align="center" width="44">&nbsp;</td>
            </tr>
            <?php do { ?>
            <tr>
              <td class = "di" align="center" width="30"><input type="checkbox" name="check[]" id="checkbox" value = "<?php echo $row_Recordset1['FST_ID']; ?>"/></td>
            ...
            <td class = "di" align="center" width="217"><?php echo $row_Recordset1['Stot_Topic']; ?></td>
            <td align="center" width="44"><a class="SelectedLeftMenu" href="stusendmessagedetail.php?fstid=<?php echo $row_Recordset1['FST_ID']; ?>">详细</a></td>
            </tr>
        ...
        </table><?php } else echo "当前没有已发送留言！";?></form></td>
