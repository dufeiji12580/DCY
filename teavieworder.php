...
<?php 
	if($_SERVER['REQUEST_METHOD'] == 'POST')						
	{
		if($_POST['check'])											
		{
			...
			{
				mysql_query("update Apply_form set teadelete = 1 where FA_ID = ".$id,$myconn);
				mysql_query("delete from Apply_form where FA_ID = ".$id." and studelete = 1",$myconn);
			}
		}
	}
?>
...
$query_Recordset1 = "SELECT FA_ID,FS_ID,S_Username,S_Name,Apply_Time,T_Username,State,View FROM student natural join apply_form where T_Username = '".$_SESSION[T_Username]."' and teadelete = 0 order by State desc,Apply_Time desc";
  ...
  <tr>
    ...
    <tr>
      ...
      <td width="638" rowspan="2" valign="top"><div align="center"><form name="form2" action="" method = "post">
        <?php if($totalRows_Recordset1!=0){?><table width="500" border="0" >
          <tr>
            <td colspan="5" align="center">预约信息列表：</td>
            </tr>
            <tr>
            <td colspan="5"><div align="right">共有<?php echo $totalRows_Recordset1; ?>条记录</div></td>
            </tr>
            <tr>
              <td align="center" width="31"><input type="checkbox" name="allbox" id="allbox" onclick = javascript:CA() /></td>
              <td align="center" width="143">学生姓名</td>
              <td align="center" width="173">预约请求时间</td>
              <td align="center" width="81">状态</td>
              <td align="center" width="50">&nbsp;</td>
            </tr>
            <?php do { ?>
            <tr>
              <td <?php if($row_Recordset1['View'] == 1) echo "class = \"di2\""; else echo "class = \"di\"";?> align="center" width="31"><input type="checkbox" name="check[]" id="checkbox" value = "<?php echo $row_Recordset1['FA_ID']; ?>"/></td>
            <td height = "30" <?php if($row_Recordset1['View'] == 1) echo "class = \"di2\""; else echo "class = \"di\"";?> align="center" width="143"><a href="stuinfo.php?fsid=<?php echo $row_Recordset1['FS_ID']; ?>"><?php echo $row_Recordset1['S_Name']; ?></a></td>
            <td <?php if($row_Recordset1['View'] == 1) echo "class = \"di2\""; else echo "class = \"di\"";?> align="center" width="173"><?php echo $row_Recordset1['Apply_Time']; ?></td>
            <td <?php if($row_Recordset1['View'] == 1) echo "class = \"di2\""; else echo "class = \"di\"";?> align="center" width="81">
            ...
            <td align="center" width="50"><a href="teaorderdetail.php?faid=<?php echo $row_Recordset1['FA_ID']; ?>">详细</a></td>
            </tr>
        ...
        </table><?php } else echo "当前没有预约！";?></form>
      </div></td>
