...
$query_Recordset1 = "SELECT FA_ID,FS_ID,S_Username,S_Name,Apply_Time,T_Username,State,View FROM student natural join apply_form where T_Username = '".$_SESSION[T_Username]."' and teadelete = 0 order by Apply_Time desc";
      ...
      <td width="638" rowspan="2" valign="top"><div align="center"><form name="form2" action="" method = "post">
        <?php if($totalRows_Recordset1!=0){?><table width="500" border="0" >
          <tr>
            ...
            <td align="center" width="50"><a class="SelectedLeftMenu" href="teaorderdetail.php?faid=<?php echo $row_Recordset1['FA_ID']; ?>">详细</a></td>
            </tr>
