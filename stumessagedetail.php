...
mysql_query("update ttosmessage set View = 1 where FTT_ID = ".$stumessagedetailfttid,$myconn);
  ...
  <tr>
    ...
    <tr>
      ...
      <td width="638" rowspan="2" valign="top" align="center"><table width="433" border="0">
        ...
        <tr>
          <td>&nbsp;</td>
          <td width="166" align="center"><a class="SelectedLeftMenu" href="stuleavemessage.php?ftid=<?php echo $stumessagedetailinfo[FT_ID];?>">回复留言</a></td>
