...
<div align="center">
  ...
  <tr>
    ...
    <tr>
      ...
      <td width="638" rowspan="2" valign="top" align="center"><table width="560" border="0" >
          <tr>
            ...
            <td align="center" width="50"><?php if($totalRows_Recordset1!=0){?><a href="stuordertea.php?ftid=<?php echo $row_Recordset1['FT_ID']; ?>&y=<?php echo $year; ?>&m=<?php echo $month; ?>&d=<?php echo $day; ?>&h=<?php echo $hours; ?>&mi=<?php echo $minutes; ?>">预约</a><?php } ?></td>
            </tr>
