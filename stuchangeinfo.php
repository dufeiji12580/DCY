...
$stuchangeinfosql=mysql_query("select * from student where S_Username='".$_SESSION[S_Username]."'",$myconn);
...
<div align="center">
  ...
  <tr>
    ...
    <tr>
      ...
      <td width="638" rowspan="2" valign="top" align="center"><form id="form2" name="form2" method="post" action="stusavechangeinfo.php" onsubmit="return chkinput(this)" >
