...
if(!$_SESSION[S_Username] && !$_SESSION[T_Username]){
	...
	$pathtoview = "<a href = \"stuviewpersonal.php\">个人信息</a>";
	$pathtochangepass = "<a href = \"stuchangepassword.php\">修改密码</a>";
	...
	$pathtoview = "<a href = \"teaviewpersonal.php\">个人信息</a>";
	$pathtochangepass = "<a href = \"teachangepassword.php\">修改密码</a>";
