...
$stumessagedetailfstid = trim($_GET[fstid]);
$sql = "select FT_ID,T_Name,T_Academy,Stot_Topic,Stot_Info,Stot_Time from stotmessage natural join teacher where FST_ID = ".$stumessagedetailfstid;
  ...
  <tr>
    ...
    <tr>
      ...
      <td width="638" rowspan="2" valign="top" align="center"><table width="433" border="0">
        ...
        <tr>
          <td>时间：</td>
          <td colspan="2" class="di"><?php echo $stumessagedetailinfo[Stot_Time];?></td>
        </tr>
        <tr>
          <td valign="top">主题：</td>
          <td colspan="2" valign="top" class="di"><?php echo $stumessagedetailinfo[Stot_Topic];?></td>
        </tr>
        <tr>
          <td valign="top">内容：</td>
          <td colspan="2" valign="top" class="di"><?php echo $stumessagedetailinfo[Stot_Info];?></td>
        </tr>
        <tr>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
