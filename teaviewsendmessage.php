      ...
      <td width="638" rowspan="2" valign="top"><div align="center"><form name="form2" action="" method = "post">
        <?php if($totalRows_Recordset1!=0){?><table width="495" border="0" >
          <tr>
            ...
            <td height = "30" class = "di" align="center" width="143"><a class="SelectedLeftMenu" href="stuinfo.php?fsid=<?php echo $row_Recordset1['FS_ID']; ?>"><?php echo $row_Recordset1['S_Name']; ?></a></td>
            <td class = "di" align="center" width="242"><?php echo $row_Recordset1['Ttos_Topic']; ?></td>
            <td align="center" width="60"><a class="SelectedLeftMenu" href="teasendmessagedetail.php?fttid=<?php echo $row_Recordset1['FTT_ID']; ?>">详细</a></td>
            </tr>
