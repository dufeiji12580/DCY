...
$query_Recordset1 = "SELECT * FROM news order by N_ID Desc";
    ...
    <tr>
      <td align="center"><form name="form2" action="" method = "post"><table width="654" border="0" >
        ...
        <tr>
          ...
          <td height = "30" class = "di" align="center" width="143"><a class="SelectedLeftMenu" href="<?php echo $row_Recordset1['N_Label_Url'];?>" target="_blank"><?php echo $row_Recordset1['N_Label']; ?></a></td>
          <td class = "di" align="center" width="460"><a class="SelectedLeftMenu" href="<?php echo $row_Recordset1['N_News_Url'];?>" target="_blank"><?php echo $row_Recordset1['N_News']; ?></a></td>
        </tr>
