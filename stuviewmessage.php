...
<?php 
	if($_SERVER['REQUEST_METHOD'] == 'POST')						
	{
		if($_POST['check'])											
		{
			...
			{
				mysql_query("update ttosmessage set studelete = 1 where FTT_ID = ".$id,$myconn);
				mysql_query("delete from ttosmessage where FTT_ID = ".$id." and teadelete = 1",$myconn);
			}
		}
	}
?>
...
$query_Recordset1 = "SELECT FT_ID,FTT_ID,T_Name,Ttos_Topic,View FROM teacher natural join ttosmessage where S_Username = '".$_SESSION[S_Username]."' and studelete = 0 order by FTT_ID desc";
...
<div align="center">
  ...
  <tr>
    ...
    <tr>
      ...
      <?php if($totalRows_Recordset1!=0){?><table width="448" border="0" >
          <tr>
            ...
            <tr>
              ...
              <td align="center" width="216">主题</td>
