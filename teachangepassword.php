...
function chkuserinput(form){
	...
	if(form.T_Password.value!=form.S_Password2.value)
	 {
	 alert("密码与重复密码不同!");
	 return(false);
	 }
...
<div align="center">
  ...
  <tr>
    ...
    <tr>
      ...
      <td width="638" rowspan="2" valign="top" align="center"><form id="form2" name="form2" method="post" action="teasavechangepassword.php" onSubmit="return chkuserinput(this)">
        <table width="290" border="0">
          ...
          <tr>
            ...
            <td><label for="textfield2"></label>
              <input name="T_Password" type="password" id="textfield2" size="20" maxlength="20" /></td>
          </tr>
          <tr>
            <td>确认密码：</td>
            <td><input name="T_Password2" type="password" id="textfield3" size="20" maxlength="20" /></td>
          </tr>
          <tr>
            <td>&nbsp;&nbsp;&nbsp;&nbsp;
