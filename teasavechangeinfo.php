...
if($_POST[T_Question] == "1")
    ...
    mysql_query("update teacher set T_Name = '$T_Name',T_Phone = '$T_Phone',T_Sex = '$T_Sex',T_Email = '$T_Email',T_Academy = '$T_Academy',T_Major = '$T_Major',T_Question = '$T_Question',T_Answer = '$T_Answer',T_Basic_Info = '$T_Info',T_Research_Derection = '$T_Research',T_Research_Achievement = '$T_Achievement' where T_Username = '$_SESSION[T_Username]'",$myconn);
    echo "<script>alert('修改成功!');window.location='teaindex.php';</script>";
?>