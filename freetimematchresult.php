    ...
    <tr>
      ...
      <td width="638" rowspan="2" valign="top" align="center"><?php if($totalRows_Recordset1!=0){?><table width="560" border="0" >
          <tr>
            ...
            <td align="center" width="85"><a class="SelectedLeftMenu" href="stusearchteafreetime.php?ftid=<?php echo $row_Recordset1['FT_ID'];?>">空闲时间</a></td>
            <td align="center" width="50"><a class="SelectedLeftMenu" href="stuordertea.php?ftid=<?php echo $row_Recordset1['FT_ID']; ?>&y=<?php echo $year; ?>&m=<?php echo $month; ?>&d=<?php echo $day; ?>&h=<?php echo $hours; ?>&mi=<?php echo $minutes; ?>">预约</a></td>
            </tr>
