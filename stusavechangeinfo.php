...
if($_POST[S_Question] == "1")
    ...
    mysql_query("update student set S_Name = '$S_Name',S_Phone = '$S_Phone',S_Sex = '$S_Sex',S_Class = '$S_Class',S_Number = '$S_Number',S_Email = '$S_Email',S_Academy = '$S_Academy',S_Major = '$S_Major',S_Question = '$S_Question',S_Answer = '$S_Answer' where S_Username = '$_SESSION[S_Username]'",$myconn);
    echo "<script>alert('修改成功!');window.location='stuindex.php';</script>";
?>